...
var Text = styled__default['default'].div(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  color: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  line-height: 1.5;\n  ", "\n  ", "\n"], ["\n  color: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  line-height: 1.5;\n  ", "\n  ", "\n"])), getColor$1, getFontSize, function (_a) {
    var bold = _a.bold;
    return (bold ? 600 : 400);
}, function (_a) {
...
var ButtonFixed$1 = styled__default['default'](StyledButton)(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  color: black;\n"], ["\n  color: black;\n"])));
var Button = function (_a) {
    ...
    return (React__default['default'].createElement(ButtonFixed$1, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
...
var Icon$F = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/lime/logo.png" })));
};
...
var Icon$A = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/lime/9.png" })));
};
...
var Flex = styled__default['default'].div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  display: flex;\n  ", "\n  ", "\n"], ["\n  display: flex;\n  ", "\n  ", "\n"])), styledSystem.flexbox, styledSystem.space);
...
var IconLabel = styled__default['default'].div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 16px 0 0 16px;\n  color: ", ";\n  padding: 12px;\n"], ["\n  background-color: ", ";\n  border-radius: 16px 0 0 16px;\n  color: ", ";\n  padding: 12px;\n"])), getThemeColor, function (_a) {
    var theme = _a.theme;
...
var DefaultSeparator = React__default['default'].createElement(Icon$N, { color: "currentColor", width: "24px" });
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$C, { color: "primary", ml: "4px" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/lime/9.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? '/images/lime/LogoTextNewDark.png' : '/images/lime/LogoTextNewWhite.png' })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Icon$F, { className: "mobile-icon" }),
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React__default['default'].createElement(Icon$X, null) : React__default['default'].createElement(Icon$Y, null)),
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                React__default['default'].createElement(Icon$A, { width: "24px", mr: "8px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$I, { width: "20px", color: "primary", ml: "4px" }),
...
var ButtonFixed = styled__default['default'](Button)(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  color: black;\n"], ["\n  color: black;\n"])));
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout;
    var _b = useWalletModal(login, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(ButtonFixed, { size: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(ButtonFixed, { size: "sm", onClick: function () {
...
exports.AddIcon = Icon$$;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$_;
exports.ArrowDownIcon = Icon$Z;
exports.ArrowDropDownIcon = Icon$Y;
exports.ArrowDropUpIcon = Icon$X;
exports.ArrowForwardIcon = Icon$W;
exports.AutoRenewIcon = Icon$V;
exports.BackgroundImage = BackgroundImage;
exports.BaseLayout = GridLayout$1;
exports.BinanceIcon = Icon$U;
exports.BlockIcon = Icon$11;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$T;
exports.Button = Button;
exports.ButtonMenu = ButtonMenu;
exports.ButtonMenuItem = ButtonMenuItem;
exports.CalculateIcon = Icon$R;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardRibbon = CardRibbon;
exports.CardViewIcon = Icon$S;
exports.CardsLayout = GridLayout;
exports.Checkbox = Checkbox;
exports.CheckmarkCircleIcon = Icon$13;
exports.CheckmarkIcon = Icon$Q;
exports.ChevronDownIcon = Icon$P;
exports.ChevronLeftIcon = Icon$O;
exports.ChevronRightIcon = Icon$N;
...
exports.ErrorIcon = Icon$12;
exports.Flex = Flex;
exports.GooseRoundIcon = Icon$z;
exports.Heading = Heading;
exports.HelpIcon = Icon$H;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$10;
exports.Input = Input$1;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$G;
exports.LogoIcon = Icon$F;
exports.LogoRoundIcon = Icon$E;
exports.Menu = Menu;
exports.MinusIcon = Icon$D;
exports.Modal = Modal;
exports.ModalProvider = ModalProvider;
exports.OpenNewIcon = Icon$C;
exports.PancakeRoundIcon = Icon$A;
exports.PancakesIcon = Icon$B;
