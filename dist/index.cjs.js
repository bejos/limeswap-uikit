...
var rotate$1 = styled.keyframes(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$M, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React__default['default'].createElement(Icon$O, { color: "currentColor", width: "24px" });
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$$, { color: "primary" }))),
            ...
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$M, { color: "primary" })))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Icon$G, { className: "mobile-icon" }),
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React__default['default'].createElement(Icon$Y, null) : React__default['default'].createElement(Icon$Z, null)),
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React__default['default'].createElement(Icon$I, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$J, { width: "20px", color: "primary", ml: "4px" }),
...
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$$;
exports.ArrowDownIcon = Icon$_;
exports.ArrowDropDownIcon = Icon$Z;
exports.ArrowDropUpIcon = Icon$Y;
exports.ArrowForwardIcon = Icon$X;
exports.AutoRenewIcon = Icon$W;
exports.BackgroundImage = BackgroundImage;
exports.BaseLayout = GridLayout$1;
exports.BinanceIcon = Icon$V;
exports.BlockIcon = Icon$12;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$U;
exports.Button = Button;
exports.ButtonMenu = ButtonMenu;
exports.ButtonMenuItem = ButtonMenuItem;
exports.CalculateIcon = Icon$S;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardRibbon = CardRibbon;
exports.CardViewIcon = Icon$T;
exports.CardsLayout = GridLayout;
exports.Checkbox = Checkbox;
exports.CheckmarkCircleIcon = Icon$14;
exports.CheckmarkIcon = Icon$R;
exports.ChevronDownIcon = Icon$Q;
exports.ChevronLeftIcon = Icon$P;
exports.ChevronRightIcon = Icon$O;
exports.ChevronUpIcon = Icon$N;
exports.CloseIcon = Icon$M;
exports.CogIcon = Icon$L;
exports.CommunityIcon = Icon$K;
exports.CopyIcon = Icon$J;
exports.CopyToClipboard = CopyToClipboard;
exports.Dropdown = Dropdown;
exports.ErrorIcon = Icon$13;
exports.Flex = Flex;
exports.GooseRoundIcon = Icon$A;
exports.Heading = Heading;
exports.HelpIcon = Icon$I;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$11;
exports.Input = Input$1;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$H;
exports.LogoIcon = Icon$G;
exports.LogoRoundIcon = Icon$F;
exports.Menu = Menu;
exports.MinusIcon = Icon$E;
exports.Modal = Modal;
...
exports.ProgressBunny = Icon$w;
exports.Radio = Radio;
exports.RemoveIcon = Icon$y;
exports.ResetCSS = ResetCSS;
exports.SearchIcon = Icon$s;
