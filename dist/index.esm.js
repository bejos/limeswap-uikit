...
var rotate$1 = keyframes(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var templateObject_1$M, templateObject_2$f, templateObject_3$8;
...
var ButtonFixed$1 = styled(StyledButton)(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  color: black;\n"], ["\n  color: black;\n"])));
var Button = function (_a) {
    ...
    return (React.createElement(ButtonFixed$1, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
...
var Icon$F = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/lime/logo.png" })));
};
...
var Icon$A = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/lime/9.png" })));
};
...
var Flex = styled.div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  display: flex;\n  ", "\n  ", "\n"], ["\n  display: flex;\n  ", "\n  ", "\n"])), flexbox, space);
...
var templateObject_1$G, templateObject_2$e, templateObject_3$7, templateObject_4$3;
...
var DefaultSeparator = React.createElement(Icon$N, { color: "currentColor", width: "24px" });
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/lime/9.png" })));
};
...
var templateObject_1$j, templateObject_2$8, templateObject_3$5, templateObject_4$2, templateObject_5$1;
        ...
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$_, { color: "primary" }))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$F, { className: "mobile-icon" }),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$X, null) : React.createElement(Icon$Y, null)),
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                React.createElement(Icon$A, { width: "24px", mr: "8px" }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$H, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$I, { width: "20px", color: "primary", ml: "4px" }),
...
var ButtonFixed = styled(Button)(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  color: black;\n"], ["\n  color: black;\n"])));
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout;
    var _b = useWalletModal(login, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React.createElement("div", null, account ? (React.createElement(ButtonFixed, { size: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(ButtonFixed, { size: "sm", onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#343135", backgroundDisabled: "#3c3742", contrast: "#3c3742", invertedContrast: "#BFFF00", input: "#483f5a", tertiary: "#353547", text: "#93BE19", textDisabled: "#666171", textSubtle: "#B8CB82", borderColor: "#524B63", card: "#0f0f0f", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#AEC470", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#3c3742", invertedContrast: "#BFFF00", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#93BE19", textDisabled: "#666171", textSubtle: "#B8CB82", borderColor: "#524B63", card: "#0f0f0f", gradients: {
...
export { Icon$$ as AddIcon, Alert, Icon$_ as ArrowBackIcon, Icon$Z as ArrowDownIcon, Icon$Y as ArrowDropDownIcon, Icon$X as ArrowDropUpIcon, Icon$W as ArrowForwardIcon, Icon$V as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$U as BinanceIcon, Icon$11 as BlockIcon, Breadcrumbs, Icon$T as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$R as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$S as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$13 as CheckmarkCircleIcon, Icon$Q as CheckmarkIcon, Icon$P as ChevronDownIcon, Icon$O as ChevronLeftIcon, Icon$N as ChevronRightIcon, Icon$M as ChevronUpIcon, Icon$L as CloseIcon, Icon$K as CogIcon, Icon$J as CommunityIcon, Icon$I as CopyIcon, CopyToClipboard, Dropdown, Icon$12 as ErrorIcon, Flex, Icon$z as GooseRoundIcon, Heading, Icon$H as HelpIcon, IconButton, Image, Icon$10 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$G as ListViewIcon, Icon$F as LogoIcon, Icon$E as LogoRoundIcon, Menu, Icon$D as MinusIcon, Modal, ModalProvider, Icon$C as OpenNewIcon, Icon$A as PancakeRoundIcon, Icon$B as PancakesIcon, Icon$y as PrizeIcon, Progress, Icon$v as ProgressBunny, Radio, Icon$x as RemoveIcon, ResetCSS, Icon$r as SearchIcon, Skeleton, Spinner, Svg, Icon$q as SwapVertIcon, Icon$p as SyncAltIcon, Tag, Text, Icon$t as Ticket, Icon$s as TicketRound, ToastContainer, Toggle, Icon$w as VerifiedIcon, Icon$o as WarningIcon, Icon$u as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
