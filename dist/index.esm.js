...
var DefaultSeparator = React.createElement(Icon$O, { color: "currentColor", width: "24px" });
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$G, { className: "mobile-icon" }),
        React.createElement(Logo$1, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$l, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$m, { width: "24px", color: "textSubtle" }))),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$Y, null) : React.createElement(Icon$Z, null)),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$I, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$J, { width: "20px", color: "primary", ml: "4px" }),
...
export { Icon$10 as AddIcon, Alert, Icon$$ as ArrowBackIcon, Icon$_ as ArrowDownIcon, Icon$Z as ArrowDropDownIcon, Icon$Y as ArrowDropUpIcon, Icon$X as ArrowForwardIcon, Icon$W as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$V as BinanceIcon, Icon$12 as BlockIcon, Breadcrumbs, Icon$U as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$S as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$T as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$14 as CheckmarkCircleIcon, Icon$R as CheckmarkIcon, Icon$Q as ChevronDownIcon, Icon$P as ChevronLeftIcon, Icon$O as ChevronRightIcon, Icon$N as ChevronUpIcon, Icon$M as CloseIcon, Icon$L as CogIcon, Icon$K as CommunityIcon, Icon$J as CopyIcon, CopyToClipboard, Dropdown, Icon$13 as ErrorIcon, Flex, Icon$A as GooseRoundIcon, Heading, Icon$I as HelpIcon, IconButton, Image, Icon$11 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$H as ListViewIcon, Icon$G as LogoIcon, Icon$F as LogoRoundIcon, Menu, Icon$E as MinusIcon, Modal, ModalProvider, Icon$D as OpenNewIcon, Icon$B as PancakeRoundIcon, Icon$C as PancakesIcon, Icon$z as PrizeIcon, Progress, Icon$w as ProgressBunny, Radio, Icon$y as RemoveIcon, ResetCSS, Icon$s as SearchIcon, Skeleton, Spinner, Svg, Icon$r as SwapVertIcon, Icon$q as SyncAltIcon, Tag, Text, Icon$u as Ticket, Icon$t as TicketRound, ToastContainer, Toggle, Icon$x as VerifiedIcon, Icon$p as WarningIcon, Icon$v as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
